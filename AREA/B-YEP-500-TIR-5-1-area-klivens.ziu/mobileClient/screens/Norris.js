...
export default class Norris extends React.Component {
    ...
    createservice = async () => {
        ...
        createastronaut(userId, token, this.norrisData);
    ...
    render() {
        return (
            ...
            <View style={{ display: 'flex', flex: 1 }}>
                ...
                <Header title='Norris' navigation={this.props.navigation} />
                ...
                <View style={styles.container}>
                    ...
                    <Image style={{ height: 170, width: 300, marginTop: 20 }}
                        source={require('../images/norris_default.jpg')}
                    />
