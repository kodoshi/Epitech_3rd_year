    ...
    return (
      <div className="edit">
        <div className="container cont">
          <h2 className="mt-5 mb-5 text-center font1 frenci4">
          ...
          <div className="form-group">
            <label className="text-light font frenci4">Profile Photo: </label>
            <input
              type="file"
          ...
          <div className="form-group">
            <label className="text-light font frenci4">Username: </label>
            <input
              type="text"
          ...
          <div className="form-group">
            <label className="text-light font frenci4">About me: </label>
            <textarea
              type="text"
          ...
          <div className="form-group ">
            <label className="text-light font frenci4">Email: </label>
            <input
              type="email"
          ...
          <div className="form-group">
            <label className="text-light font frenci4">Password: </label>
            <input
              type="password"
