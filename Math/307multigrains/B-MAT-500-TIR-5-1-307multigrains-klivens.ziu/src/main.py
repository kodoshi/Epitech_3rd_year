...
ALL_QUANTITIES = [OAT_QUANTITY, WHEAT_QUANTITY,
                  CORN_QUANTITY, BARLEY_QUANTITY, SOY_QUANTITY]
...
def step(matrice, bottomMatriceVector, rightMatriceVector, leftMatriceVector, total):
    pivotCoord = findPivot(matrice, bottomMatriceVector,
                           rightMatriceVector, leftMatriceVector)
...
def display(initRightMatrice, bottomMatriceVector, rightMatriceVector, leftMatriceVector, total, initBottomMatrice):
    ...
    printGrains(ALL_GRAINS, leftMatriceVector,
                rightMatriceVector, initBottomMatrice)
...
def main():
    ...
    try:
        ...
        process(matrice, bottomMatriceVector,
                rightMatriceVector, leftMatriceVector, total)
        display(initRightMatrice, bottomMatriceVector, rightMatriceVector,
                leftMatriceVector, total, initBottomMatrice)
        return 0
